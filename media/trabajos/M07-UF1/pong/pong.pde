...
void setup() { 
  ...
  fons = loadImage("media/trabajos/M07-UF1/pong/fons.jpg");
  jugador1guanyar = loadImage("media/trabajos/M07-UF1/pong/jugador1guanyar.jpg");
  jugador2guanyar = loadImage("media/trabajos/M07-UF1/pong/jugador2guanyar.jpg");
  inici = loadImage("media/trabajos/M07-UF1/pong/inici.jpg");
  inici_comencar = loadImage("media/trabajos/M07-UF1/pong/inici_comencar.jpg");
  inici_controls = loadImage("media/trabajos/M07-UF1/pong/inici_controls.jpg");
  inici_opcions = loadImage("media/trabajos/M07-UF1/pong/inici_opcions.jpg");
  controls_clicant = loadImage("media/trabajos/M07-UF1/pong/controls_clicant.jpg");
  controls_sense_clicar = loadImage("media/trabajos/M07-UF1/pong/controls_sense_clicar.jpg");
  ajud_espai = loadImage("media/trabajos/M07-UF1/pong/ajud_espai.png");
  opcions_sense_clicar = loadImage("media/trabajos/M07-UF1/pong/opcions_sense_clicar.jpg");
  opcions_clicant_enrere = loadImage("media/trabajos/M07-UF1/pong/opcions_clicant_enrere.jpg");
  opcions_clicant_facil = loadImage("media/trabajos/M07-UF1/pong/opcions_clicant_facil.jpg");
  opcions_clicant_normal = loadImage("media/trabajos/M07-UF1/pong/opcions_clicant_normal.jpg");
  opcions_clicant_dificil = loadImage("media/trabajos/M07-UF1/pong/opcions_clicant_dificil.jpg");
  guardat = loadImage("media/trabajos/M07-UF1/pong/guardat.png");
