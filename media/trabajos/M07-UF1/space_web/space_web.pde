...
void setup() {
  size(1000, 600);
  portada = loadImage("media/trabajos/M07-UF1/space_web/images/portada.png");
  nave = loadImage("media/trabajos/M07-UF1/space_web/images/SI_Nau.png");
  enemigo = loadImage("media/trabajos/M07-UF1/space_web/images/SI_Enemic.png");
  fondo = loadImage("media/trabajos/M07-UF1/space_web/images/SI_Fons.png");
  ajud_espai = loadImage("media/trabajos/M07-UF1/space_web/images/ganar.png");
  guardado = loadImage("media/trabajos/M07-UF1/space_web/images/perder.png");
